...
(function($PS) {
  ...
  var Options_Applicative_Types = $PS["Options.Applicative.Types"];                
  var Hello = (function () {
      function Hello(value0) {
          this.value0 = value0;
      };
      Hello.create = function (value0) {
          return new Hello(value0);
      };
      return Hello;
  })();
  var Goodbye = (function () {
      ...
      Goodbye.value = new Goodbye();
      return Goodbye;
  })();
  var sampleEq = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Hello && y instanceof Hello) {
              return Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(x.value0)(y.value0);
          };
          if (x instanceof Goodbye && y instanceof Goodbye) {
              return true;
          };
          return false;
      };
  ...
  var run = function (v) {
      if (v instanceof Hello) {
          return Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Hello, " + (Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(", ")(v.value0) + "!"));
      };
      if (v instanceof Goodbye) {
          return Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Goodbye.");
      };
      throw new Error("Failed pattern match at Main (line 45, column 1 - line 45, column 29): " + [ v.constructor.name ]);
  };
  var hello = Data_Functor.map(Options_Applicative_Types.parserFunctor)((function () {
      var $18 = Data_Array.fromFoldable(Data_List_Types.foldableList);
      return function ($19) {
          return Hello.create($18($19));
      };
  })())(Options_Applicative_Types.many(Options_Applicative_Builder.argument(Options_Applicative_Builder.str)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.argumentFieldsHasMetavar)("TARGET..."))));
  var sample = Control_Alt.alt(Options_Applicative_Types.parserAlt)(Options_Applicative_Builder.subparser(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.command("hello")(Options_Applicative_Builder.info(hello)(Options_Applicative_Builder.progDesc("Print greeting"))))(Options_Applicative_Builder.command("goodbye")(Options_Applicative_Builder.info(Control_Applicative.pure(Options_Applicative_Types.parserApplicative)(Goodbye.value))(Options_Applicative_Builder.progDesc("Say goodbye"))))))(Options_Applicative_Builder.subparser(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.command("bonjour")(Options_Applicative_Builder.info(hello)(Options_Applicative_Builder.progDesc("Print greeting"))))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.command("au-revoir")(Options_Applicative_Builder.info(Control_Applicative.pure(Options_Applicative_Types.parserApplicative)(Goodbye.value))(Options_Applicative_Builder.progDesc("Say goodbye"))))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.commandGroup("French commands:"))(Options_Applicative_Builder.hidden)))));
  var opts = Options_Applicative_Builder.info(Options_Applicative_Internal_Utils.apApplyFlipped(Options_Applicative_Types.parserApply)(sample)(Options_Applicative_Extra.helper))(Options_Applicative_Builder.idm(Options_Applicative_Builder.infoModMonoid));
  var main = Control_Bind.bind(Effect.bindEffect)(Options_Applicative_Extra.execParser(opts))(run);
  var genericSample = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Hello) {
          return new Data_Generic_Rep.Inl(x.value0);
      };
      if (x instanceof Goodbye) {
          return new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value);
      };
      throw new Error("Failed pattern match at Main (line 18, column 1 - line 18, column 50): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return new Hello(x.value0);
      };
  ...
  var showSample = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericSample)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showArray(Data_Show.showString)))(new Data_Symbol.IsSymbol(function () {
      return "Hello";
  ...
  exports["opts"] = opts;
  exports["main"] = main;
  exports["sampleEq"] = sampleEq;
  exports["genericSample"] = genericSample;
